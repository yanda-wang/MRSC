...
search_space = [Categorical(categories=['64', '128', '200', '256', '300', '400'], name='dimension'),
                ...
                Integer(low=2, high=5, name='decoder_select_adm_count'),
...
def fitness(dimension, encoder_n_layers, encoder_embedding_dropout_rate, encoder_gru_dropout_rate, decoder_dropout_rate,
    ...
    print('decoder_select_adm_count:', decoder_select_adm_count)
    ...
    model = MedRecSeq2SetSumCoverTrainer(criterion=nn.BCEWithLogitsLoss, optimizer_encoder=optim.Adam,
                                         ...
                                         module__procedures_count=PROCEDURES_COUNT,
                                         ...
                                         module__decoder__least_adm_count=decoder_least_adm_count.item(),
                                         module__decoder__select_adm_count=decoder_select_adm_count.item(),
